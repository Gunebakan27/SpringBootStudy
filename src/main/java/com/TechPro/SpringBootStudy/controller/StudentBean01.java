...
@Component  //Bileşen tamamlayıcı: kullanıcı claass tan obje IoC create eder
// new StudentBean01();--> tight coupling ama@Component loose coupling (oj inject)
public class StudentBean01 implements StudentInterface {
    ...
    @Override
    public String study() {
        return "bu yazıyı okuduysan StudentBean01 class'ından geliyom :-) ";
    }
}